...
public class KitsuneEntityModelUpdated<T extends KitsuneEntity> extends EntityModel<T> {
    ...
    public RendererModel right_hip;
    public RendererModel tail1center;
    public RendererModel LeftHip;
    public RendererModel tail1right;
    public RendererModel tail1left;
    public RendererModel ShinRight;
    public RendererModel AnkleRight;
    public RendererModel FootRight;
    public RendererModel tail2center;
    public RendererModel tail3center;
    public RendererModel tail4center;
    public RendererModel ShinLeft;
    public RendererModel AnkleLeft;
    public RendererModel FootLeft;
    public RendererModel tail2right;
    public RendererModel tail3right;
    public RendererModel tail4right;
    public RendererModel tail2left;
    public RendererModel tail3left;
    public RendererModel tail4left;
    public RendererModel rarm2;
    public RendererModel rarm3;
    public RendererModel rclaws;
    public RendererModel larm2;
    public RendererModel larm3;
    public RendererModel lclaws;
    public RendererModel KatanaHandle;
    public RendererModel KatanaBlade;
    ...
    public KitsuneEntityModelUpdated() {
        ...
        this.ShinRight = new RendererModel(this, 40, 23);
        ...
        this.Waist = new RendererModel(this, 35, 15);
        ...
        this.RightEar = new RendererModel(this, 18, 0);
        ...
        this.rarm3 = new RendererModel(this, 30, 46);
        ...
        this.tail4right = new RendererModel(this, 16, 37);
        ...
        this.tail3left = new RendererModel(this, 21, 41);
        ...
        this.tail1center = new RendererModel(this, 39, 6);
        ...
        this.tail1right = new RendererModel(this, 16, 20);
        ...
        this.ShinLeft = new RendererModel(this, 36, 31);
        ...
        this.leftear = new RendererModel(this, 12, 10);
        ...
        this.tail4left = new RendererModel(this, 0, 46);
        ...
        this.Snout = new RendererModel(this, 51, 53);
        ...
        this.KatanaBlade = new RendererModel(this, 0, 51);
        ...
        this.leftShoulder = new RendererModel(this, 51, 3);
        ...
        this.RightShoulder = new RendererModel(this, 42, 0);
        ...
        this.AnkleRight = new RendererModel(this, 54, 9);
        ...
        this.tail4center = new RendererModel(this, 28, 31);
        ...
        this.FootLeft = new RendererModel(this, 24, 36);
        ...
        this.tail3right = new RendererModel(this, 35, 39);
        ...
        this.rclaws = new RendererModel(this, 16, 45);
        ...
        this.AnkleLeft = new RendererModel(this, 48, 32);
        ...
        this.tail2right = new RendererModel(this, 0, 37);
